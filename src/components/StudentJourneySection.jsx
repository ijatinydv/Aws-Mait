    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="space-y-24 relative z-10">
            {journeySteps.map((item, index) => (
              <div
                key={index}
                className={`milestone flex items-center ${
                  item.side === 'left' 
        ...
        <div className="text-center mt-20">
          <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 backdrop-blur-sm border border-white/20 rounded-2xl p-8 max-w-2xl mx-auto">
